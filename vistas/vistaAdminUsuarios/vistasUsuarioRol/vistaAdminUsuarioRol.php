...
<head>
    ...
    <link rel="stylesheet" href="../../../css/vistas/vistaAdminUsuarios/vistaAdminUsuarioRol.css">
...
<i class="fas fa-chevron-circle-left" id="btnVolver"><h6 id="txtVolver">Volver</h6></i>
            ...
            <h1>Administración de Usuarios Rol</h1>
            
    <header>
            <a href="../../../Controlador.php?ruta=listarUsuarios_SRoles">
        <div class="contenedor" id="uno">
        <i class="fas fa-clipboard-list" id="icoListar"></i>
        <p class="texto">Listar Usuarios con Roles</p>
        </div>
        </a>
        </header>
        <div id="">
