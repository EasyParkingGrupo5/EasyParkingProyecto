...
<head>
    ...
    <link rel="stylesheet" href="../../../css/vistas/vistaAdminUsuarios/vistaAdminRoles.css">
...
<i class="fas fa-chevron-circle-left" id="btnVolver"><h6 id="txtVolver">Volver</h6></i>
    ...
    <header>
            ...
            <a href="../../../Controlador.php?ruta=listarRoles">
        <div class="contenedor" id="uno">
        <i class="fas fa-clipboard-list" id="icoListar"></i>
        <p class="texto">Listar Roles</p>
        </div>
        </a>
        <a href="../../../Controlador.php?ruta=mostrarInsertarRoles">
        <div class="contenedor" id="dos">
        <i class="fas fa-tools" id="icoInsertar"></i>
        <p class="texto">Insertar Nuevo Rol</p>
        </div>
        </a>
        <a href="../../../Controlador.php?ruta=listarRolesInactivos">
        <div class="contenedor" id="tres">
        <i class="fas fa-trash-alt" id="icoInactivos"></i>
        <p class="texto">Listar Roles <br> Inactivos</p>
        </div>
        </a>
        </header>
        <div id="">
