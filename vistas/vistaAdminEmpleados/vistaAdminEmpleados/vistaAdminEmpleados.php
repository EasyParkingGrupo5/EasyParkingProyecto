...
<head>
    ...
    <link rel="stylesheet" href="../../../css/vistas/vistaAdminEmpleados/vistarAdminEmpleados2.css">
...
<i class="fas fa-chevron-circle-left" id="btnVolver"><h6 id="txtVolver">Volver</h6></i>
    ...
    <header>
            <a href="../../../Controlador.php?ruta=listarEmpleados">
        <div class="contenedor" id="uno">
        <i class="fas fa-clipboard-list" id="icoListar"></i>
        <p class="texto">Listar Empleados</p>
        </div>
        </a>
        <a href="../../../Controlador.php?ruta=listarEmpleadosInactivos">
        <div class="contenedor" id="tres">
        <i class="fas fa-trash-alt" id="icoInactivos"></i>
        <p class="texto">Listar Empleados <br> Inactivos</p>
        </div>
        </a>
        </header>
        <div id="">
